    ...
    return (
        <div>
            <main className="bg-black text-white font-sans">
                {/* About Section */}
                <section
                    className="flex flex-col lg:flex-row items-center justify-between p-12 border-b border-gray-800">
                ...
                {/* Legacy Section */}
                <section
                    className="flex flex-col lg:flex-row-reverse items-center justify-between p-12 border-b border-gray-800">
                    <div className="lg:w-1/2 border-2 border-gray-700 p-8 text-center mx-4">
